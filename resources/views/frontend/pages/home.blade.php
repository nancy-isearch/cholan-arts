...
<main id="main-content">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="hero-slide-bg">
              <img src="{{ asset('assets/images/banner-img/banner-slide-img1.webp') }}"
                alt=""
          ...
          <div class="swiper-slide">
            <div class="hero-slide-bg">
              <img  src="{{ asset('assets/images/banner-img/banner-slide-img2.webp') }}"
                alt=""
                class="w-100 h-100 object-fit-cover"
                loading="lazy"
              />
          ...
          <div class="swiper-slide">
            <div class="hero-slide-bg">
              <img  src="{{ asset('assets/images/banner-img/banner-slide-img3.webp') }}"
                alt=""
                class="w-100 h-100 object-fit-cover"
                loading="lazy"
              />
          ...
          <div class="swiper-slide">
            <div class="hero-slide-bg">
              <img  src="{{ asset('assets/images/banner-img/banner-slide-img4.webp') }}"
                alt=""
                class="w-100 h-100 object-fit-cover"
                loading="lazy"
              />
      ...
      <section class="about-section" aria-labelledby="about-title">
        <div
          ...
          style="background-image: url('{{ asset('assets/images/bg/about-bg.png') }}')"
        ></div>

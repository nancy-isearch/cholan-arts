    ...
    <div class="idol-hero pt-5">
      ...
      <div class="detail-col reveal" style="animation-delay: 0.1s">
        ...
        <div class="custom-note-box">
          ...
          <p class="note-text">
              We can customise this product in any size and material as per your requirements, including Brass, Bronze, Panchaloha, Wood, Marble, and custom finishes for home décor, temples, gifting, and spiritual spaces.
          </p>
        </div>

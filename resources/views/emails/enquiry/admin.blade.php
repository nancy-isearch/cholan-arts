<div style="font-family: Arial, sans-serif; font-size: 14px; color: #000;">
    <p>A new product enquiry has been submitted on <strong>{{ config('app.name') }}</strong>. Please review the details below and respond to the customer promptly.</p>
    <br>
    <p><strong>Customer Information</strong></p>
    <table style="font-size: 14px; color: #000; text-align: left;" cellpadding="3" cellspacing="0">
        <tr>
            <td style="font-weight: bold; padding-right: 20px;">Reference:</td>
            <td>ENQ-{{ str_pad($enquiry->id, 5, '0', STR_PAD_LEFT) }}</td>
        </tr>
        <tr>
            <td style="font-weight: bold; padding-right: 20px;">Date:</td>
        ...
        <tr>
            <td style="font-weight: bold; padding-right: 20px;">Full Name:</td>
    ...
    <br>
    @if($enquiry->product?->name || $enquiry->preferred_size || $enquiry->purpose || $enquiry->preferred_finish || $enquiry->message)
    ...
    <br>
    <p>
        <a href="{{ rtrim(config('app.url'), '/') }}/admin/enquiries/{{ $enquiry->id }}">View in Admin Panel</a>
    </p>
</div>
